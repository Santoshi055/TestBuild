...
post {
        always {
           emailext body: 'Check console output at $BUILD_URL to view the results.', recipientProviders: [[$class: 'DEFAULT_RECIPIENTS']], subject: 'Jenkins build is back to normal: $PROJECT_NAME - #$BUILD_NUMBER'
        }
    }
