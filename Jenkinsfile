...
post {
        always {
           emailext body: 'Check console output at $BUILD_URL to view the results.', recipientProviders: [developers()], subject: 'Jenkins build is back to normal: $PROJECT_NAME - #$BUILD_NUMBER',to:'sg185343@ncr.com'
        }
    }
